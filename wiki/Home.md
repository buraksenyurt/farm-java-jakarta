...
> Dikkat! Wiki sayfaları Claude Opus tarafından hazırlanmış ve tarafımca denetimden geçirilmiştir. Yer yer üzerinden geçip güncellemeye devam edeceğim. Sorgulayarak okumayı ihmal etmeyin.

Bu wiki, [farm-java-jakarta](https://github.com/buraksenyurt/farm-java-jakarta) deposundaki örneklerin arkasındaki kavramları **kavram kartı** biçiminde toplar. Her sayfa tek bir konuyu ele alır, yaklaşık olarak 3-6 dakikada arasında okunabilir ve depodaki gerçek koda referans verir.
